    ...
    <div class="container" id="formTicket"  style="height: 600px;display:block;">
        ...
        <div class="flight-result" style="padding: 25px; width: 90%">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        <label for="example-search-input" class="col-xs-3 col-form-label">Cancellation Fee</label>
                        <div class="col-xs-7">
                            <input class="form-control" type="text" id="admin-flight-register-cancellationFee" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-search-input" class="col-xs-3 col-form-label">Duration</label>
                        <div class="col-xs-7">
                            <input class="form-control" type="text" id="admin-flight-register-duration" />
                        </div>
                    </div> 
                </div>
            </div>
        ...
        <div class="container" style="height: 300px;display:block;overflow-y:scroll;overflow-x: hidden;">
            <div class="row">
                ...
                <div class="col-md-1 vcenter">RouteID</div>
